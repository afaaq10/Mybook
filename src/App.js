 ...
 */}
            <div className="container md:mx-auto md:px-12  md:space-x-2">
                <div className="navbar flex justify-between items-center md:space-x-2">
                    ...
                    <div className="flex justify-center items-center ">
                        ...
                        <div className="search md:order-2 md:hidden"><SearchIcon />

                        </div>
                    </div>

                    <div className=" md:flex md:space-x-8 text-center md:order-first  ">
                        <img className="md:w-[9rem]" src="https://blogs.microsoft.com/wp-content/uploads/prod/2012/08/8867.Microsoft_5F00_Logo_2D00_for_2D00_screen.jpg" alt="" />


                        <div className="invisible md:visible md:mt-[13px] hover:underline cursor-pointer">Microsoft 365</div>
                        <div className="invisible md:visible md:mt-[13px] hover:underline cursor-pointer">Windows</div>
                        <div className="invisible md:visible md:mt-[13px] hover:underline cursor-pointer ">Surface</div>
                        <div className=" invisible md:visible md:mt-[13px] hover:underline cursor-pointer">Xbox</div>
                        <div className="invisible md:visible md:mt-[13px] hover:underline cursor-pointer">Support</div>
                    </div>



                    <div className=" cart md:text-center md-order-3 md:flex md:space-x-6 md:py-4 md:px-2 ">
                        <div className="search hidden md:inline-block hover:underline">Search <SearchIcon /> </div>
                        <div className="flex space-x-4">
                            <div className="hover:underline mx-1 ">Cart</div> <div><ShoppingCartCheckoutIcon /></div>
                            <div className="hover:underline">Signin</div><div>< PersonAddAltIcon /></div>
                        </div>
                    </div>
                ...
                <div className="slider flex flex-col-reverse md:flex-row bg-[#e6e6e6] ">
                    <div className="left py-16 flex flex-col justify-center items-center md:items-baseline  ">

                        <span className="bg-yellow-400 w-fit p-2 md:mx-5">New</span>
                        <h1 className="md:mx-5 text-2xl font-bold ">Surface Pro 8</h1>
                        <p className="md:mx-5 text-center md:text-left">Do more with a larger 13-inch touchscreen, faster connections and extra speed. Now available with Windows 11.</p>

                        <button className="mt-2 w-fit mx-5 bg-black text-white md:mx-4 p-3">Learn more</button>

                    </div>


                    <div className="right"><img className="md:w-96 " src="https://ssl-product-images.www8-hp.com/digmedialib/prodimg/lowres/c07964198.png" alt="image" /> </div>
                ...
                <div className="3 py-12 space-y-5 md:flex flex-row justify-center ">


                    <div className="flex  space-x-1 items-center mx-3 space-x-2 ">
                        <img className="w-4 md:mt-[17px] md:w-6 " src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2b/Windows_logo_2012-Black.svg/768px-Windows_logo_2012-Black.svg.png" alt="" /> <span className="font-medium md:mt-[17px]  ">Choose your Microsoft 365</span>
                    </div>
            ...
            <div className="text-left mt-10  items-center space-y-8  md:container mx-8 md:flex md:justify-between md:items-center md:mt-48 md:space-x-8 md:w-auto">

                <div class="max-w-sm rounded overflow-hidden shadow-lg">
                    <img class="w-48 md:w-[10rem]" src="https://m.economictimes.com/thumb/msid-76695421,width-1200,height-900,resizemode-4,imgsize-228666/microsoft.jpg" />
                    <div class="px-6 py-4">
                        <div class="font-bold text-xl mb-2">Surface laptop</div>
                ...
                <div class="max-w-sm rounded overflow-hidden shadow-lg">
                    <img class="w-48 md:wd-[231px]" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQov2rf0WyTEUYSxDZdS6NFPE4Zpse0SNUmIg&usqp=CAU" alt="Sunset in the mountains" />
                    <div class="px-6 py-4">
                        <div class="font-bold text-xl mb-2">Surface laptop studio</div>
                        <p class="text-gray-700 text-base">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.
    </p>
                    </div>
                ...
                <div class="max-w-sm rounded overflow-hidden shadow-lg">
                    <img class="w-48 md:w-48" src="https://support.content.office.net/en-us/media/bf344753-1a4e-4b5a-b0d9-4e37a11d613d.gif" alt="Sunset in the mountains" />
                    <div class="px-6 py-4">
                        <div class="font-bold text-xl mb-2">Xbox</div>
                        <p class="text-gray-700 text-base">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.
    </p>
                    </div>
                ...
                <div class="max-w-sm rounded overflow-hidden shadow-lg">
                    <img class="w-48 md:48" src="https://cdn.mos.cms.futurecdn.net/PPEbcPVtKxkYEXhzTxLzy9.jpg" />
                    <div class="px-6 py-4">
                        <div class="font-bold text-xl mb-2">Microsoft edge</div>
                        <p class="text-gray-700 text-base">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.
    </p>
                    </div>
